...
//Otra dor de hacer lo mismo
 ...
 public function getRouteKeyName() // esto tiene que ver para generar url amigables
   ...
   // }
    ...
    {
        return $this->belongsToMany('App\Models\Plan', 'equipoplansejecuts','equipo_id','plan_id'); //OJO, Modificado 03/082024 antes "('App\Models\Plan', 'equipoplansejecut','equipo_id','plan_id')" SIN la "s" // Personalizo nombre la tabla  pivot  y el campo clave primaria
       // ->withPivot('cant','unidad','check1');
        //->withTimestamps();
       // return $this->belongsToMany('App\Models\Repuesto', 'equipo_repuestos', 'equipo_id', 'repuesto_id');
    }
